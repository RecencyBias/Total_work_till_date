...
print(inttime)
'''
'''#intreplies1 = intreplies[0:9]
#intretweets2=intretweets[0:9]
#intlikes2=intlikes[0:9] 
#inttime1=inttime[0:9]
'''
print(len(intreplies))
print(len(intretweets))
print(len(intlikes))
print(len(inttime))
print(intreplies)
print(intretweets)
...
plt.bar(x,intretweets,color='yellow',label = "No of retweets")
plt.bar(x,intreplies,color='blue',label = "No of replies")
plt.show()
import numpy
